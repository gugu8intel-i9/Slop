...
- `SIR_OPTIMIZER.md` - Phase-3 optimizer docs: folding, DCE, CSE, string fusion, branch folding, bounds-check cleanup, SEAA compression, fixed-point rounds, and parallel safety.
