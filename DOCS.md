...
- `slop_sir_optimizer.h`: Phase-3 high-performance optimizer for folding, algebraic simplification, CSE, string fusion, branch folding, pure DCE, duplicate/proven bounds-check elimination, SEAA arena compression, fixed-point rounds, and parallel-safety classification.
