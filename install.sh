...
cp hello.slop easy_start.slop low_level_demo.slop sir_pipeline_demo.slop sir_core_demo.slop sir_array_demo.slop sir_function_demo.slop sir_struct_demo.slop native_backend_demo.slop complex_syntax.slop parallel_processing.slop gpu_compute.slop \
