...
7. SIR-first `.slop -> C/ELF` pipeline subset plus `.slop -> SIR -> C` core control-flow, array, and no-arg and two-argument function, plus int/string struct fields, method-call, string arrays, and struct arrays subset
